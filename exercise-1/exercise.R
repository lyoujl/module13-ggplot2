...
ggplot(data = diamonds.sample) + geom_point(mapping = aes(x = cut, y = carat, size = price))

# Try coloring the above plot based on the diamond's price!
ggplot(data = diamonds.sample) + geom_point(mapping = aes(x = cut, y = carat, size = price, color = price))
...
ggplot(data = diamonds.sample) + geom_bar(mapping = aes(x = cut, fill = clarity))

# Draw a histogram of diamond prices.
# Try mapping each bar based on clarity as well!
ggplot(data = diamonds.sample) + geom_histogram(mapping = aes(x = price, fill = clarity))

# (For a more traditional "bell-curve", make a histogram of diamond `depths`)
ggplot(data = diamonds.sample) + geom_histogram(mapping = aes(x = depth, fill = clarity))
